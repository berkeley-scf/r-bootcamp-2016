...
% Credits: Some of these materials were adapted from [Software Carpentry](http://swcarpentry.github.io/r-novice-gapminder/)
...
`dplyr` and `tiyr` have many more functions to help you wrangle and manipulate your data. See the  [Data Wrangling Cheat Sheet](https://www.rstudio.com/wp-content/uploads/2015/02/data-wrangling-cheatsheet.pdf) for more.
...
2. Use dplyr to add a column to the gapminder dataset that contains the total population of the continent of each observation. For example, if the first observation is Afghanistan, the new column would contain the population of Asia. 
