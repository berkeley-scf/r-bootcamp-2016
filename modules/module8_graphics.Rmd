...
bwplot(Gold~Year, data = medal_counts_wide, main = "Gold Medal Counts", horizontal = FALSE) 
...
```{r}
ggplot(medal_counts_wide, aes(x = Year, y = Gold)) + geom_point() + ggtitle("Gold Medal Counts")
ggplot(usa_gold_medals, aes(x = Year, y = count)) + geom_line() + ggtitle("USA Gold Medals")

# Boxplots
ggplot(medal_counts_wide, aes(x = factor(Year), y = Gold)) + geom_boxplot() + ggtitle("Gold Medal Counts")
# Histogram
ggplot(medal_counts_wide, aes(x = Gold)) + geom_histogram() + ggtitle("Gold Medal Counts")
# Density plot
ggplot(medal_counts_wide, aes(x = Gold)) + geom_density() + ggtitle("Gold Medal Counts")
# Bar chart
...
```{r, fig.cap=" ", warning=FALSE, fig.show = "hold"}
ggplot(data = usa_gold_medals, aes(x = Year, y = count)) + geom_point() # ggplot2
ggplot(data = usa_gold_medals, aes(x = Year, y = count)) + geom_point(size=3) # ggplot2
ggplot(data = usa_gold_medals, aes(x = Year, y = count)) + geom_point(size=1) # ggplot2
```
```{r, fig.cap=" ", warning=FALSE, fig.show = "hold"}
xyplot(count~Year, data = usa_gold_medals) # lattice
...
#### Colors
```{r, fig.cap=" ", warning=FALSE, fig.show = "hold"}
ggplot(data = usa_gold_medals, aes(x = Year, y = count)) + geom_point(color = colors()[11]) # ggplot2
ggplot(data = usa_gold_medals, aes(x = Year, y = count)) + geom_point(color = "red") # ggplot2
```
```{r, fig.cap=" ", warning=FALSE, fig.show = "hold"}
...
ggplot(data = usa_all_medals, aes(x = Year, y = count)) + geom_point(color = Medal)
ggplot(data = usa_all_medals, aes(x = Year, y = count)) + geom_point(color = "Medal")
ggplot(data = usa_all_medals, aes(x = Year, y = count)) + geom_point(color = "red")
```
...
```{r, fig.cap=" ", warning=FALSE, fig.show = "hold"}
ggplot(data = usa_gold_medals, aes(x = Year, y = count)) + geom_point(shape = 3) # ggplot2
ggplot(data = usa_gold_medals, aes(x = Year, y = count)) + geom_point(shape = "w") # ggplot2
ggplot(data = usa_gold_medals, aes(x = Year, y = count)) + geom_point(shape = "$", size=5) # ggplot2
```
```{r, fig.cap=" ", warning=FALSE, fig.show = "hold"}
...
```{r, fig.cap=" ", warning=FALSE, fig.show = "hold"}
ggplot(data = usa_gold_medals, aes(x = Year, y = count)) + geom_line(linetype = 1) # ggplot2
ggplot(data = usa_gold_medals, aes(x = Year, y = count)) + geom_line(linetype = 2) # ggplot2
ggplot(data = usa_gold_medals, aes(x = Year, y = count)) + geom_line(linetype = 5, size = 2) # ggplot2
```
```{r, fig.cap=" ", warning=FALSE, fig.show = "hold"}
xyplot(count~Year, data = usa_gold_medals, type = "l", lty = 1) # lattice
xyplot(count~Year, data = usa_gold_medals, type = "l", lty = 2) # lattice
xyplot(count~Year, data = usa_gold_medals, type = "l", lty = 3, lwd = 3) # lattice
```

#### Using aesthetics to highlight features
Differences in kind
```{r, fig.cap=" ", warning=FALSE, fig.show = "hold"}
ggplot(data = northern_hem, aes(x = Year, y = Gold)) + geom_line(aes(linetype = Country))
ggplot(data = northern_hem, aes(x = Year, y = Gold)) + geom_line(aes(shape = Country))
```
Differences in degree
```{r, fig.cap=" ", warning=FALSE, fig.show = "hold"}
ggplot(data = northern_hem, aes(x = Year, y = Silver)) + geom_point(aes(color = Gold))
ggplot(data = northern_hem, aes(x = Year, y = Silver)) + geom_point(aes(size = Gold))
```
Multiple non-coordinate aesthetics (differences in kind using color, degree using point size)
```{r, fig.cap=" ", warning=FALSE}
ggplot(data = northern_hem, aes(x = Year, y = Silver)) + geom_point(aes(size = Gold, color = Country))
```
...
plot1 <- ggplot(data = medal_counts_wide, aes(x = Year, y = Gold)) + 
  ...
  ylab("Medals")
plot2 <- ggplot(data = usa_all_medals, aes(x = Year, y = count)) + geom_line(aes(color = Medal))
plot3 <- ggplot(data = northern_hem, aes(x = Year, y = Gold)) + geom_point(aes(color = Country))
