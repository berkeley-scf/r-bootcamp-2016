...
# Linux/Mac specific
setwd('~/Desktop/r-bootcamp-2016') # change the working directory
setwd('/Users/paciorek/Desktop') # absolute path
getwd()
setwd('r-bootcamp-2016/modules') # relative path
...
# platform-agnostic
setwd(file.path('~', 'Desktop', 'r-bootcamp-2016')) # change the working directory
setwd(file.path('/', 'Users', 'paciorek', 'Desktop', 'tmp')) # absolute path
getwd()
setwd(file.path('..', 'r-bootcamp-2016', 'modules')) # relative path
```
...
We'll go through a short example of making changes to the r-bootcamp-2016 repository. In this case you don't have permission to make changes so you'll just have to follow along as I do it. However, you could start your own repository and then you'd be able to do similar things.
